<%-- 
    Document   : Profile
    Created on : 6 Aug, 2022, 8:33:15 PM
    Author     : Bipin
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#">  <span class="fa fa-bell"></span> LearnCode with  <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            <a href="#" onclick="getPosts(0,this)" class=" c-link list-group-item list-group-item-active btn-colour">
                                All Posts
                            </a>
                            ...
                            <%
                                ...
                                ArrayList<category> list1 = d.getAllCategroy();
                            ...
                            <div class="form-group">
                                <select class="form-control" name="cid">
                                    ...
                                    <%
                                        ...
                                        ArrayList<category> list = postd.getAllCategroy();
        ...
        <script>
            ...
            $(document).ready(function (e) {
                $("#add-post-form").on("submit", function (event) {
                    ...
                    event.preventDefault();  //stop sysnorosoucs behaviour submit means stop normal form submit behavour
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            //if data save sucessfully to show sweetalert
                            if (data.trim() == 'done') {
